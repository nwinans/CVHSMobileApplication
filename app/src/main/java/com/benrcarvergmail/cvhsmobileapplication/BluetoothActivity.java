...
public class BluetoothActivity extends AppCompatActivity implements OnItemClickListener  {
    ...
    /**
     * Causes phone to vibrate for a set amount of time
     *
     * @param milliseconds number of milliseconds the phone vibrates
     */
    private void vibrateDevice(int milliseconds) {
        // Max of ten seconds to vibrate
        Vibrator deviceVibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
        // Maximum vibration of ten seconds
        if (milliseconds >  10000) {
            milliseconds = 10000;
        }
        deviceVibrator.vibrate(milliseconds);
    }
